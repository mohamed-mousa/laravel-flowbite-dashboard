<template>
    <div>
        <div
            ...
            class="flex items-center justify-between mb-5 max-w-3xl bg-green-500 rounded"
        >
        ...
        <div
            v-if="
                ...
                show
            "
            class="flex items-center justify-between mb-5 max-w-3xl bg-red-500 rounded"
        >
            <div class="flex items-center">
                <svg
                    class="flex-shrink-0 ml-4 mr-2 w-4 h-4 fill-white"
            ...
            <button type="button" class="group mr-2 p-2" @click="show = false">
                <svg
                    class="block w-3 h-3 fill-red-800 group-hover:fill-white"
                    xmlns="http://www.w3.org/2000/svg"
                    width="235.908"
                    height="235.908"
                    viewBox="278.046 126.846 235.908 235.908"
...
<script>
import { useHideFlashMessage } from "@/Composables/HideFlashMessage.js";
export default {
    data() {
        return {
            show: true,
